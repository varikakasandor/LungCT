...
print(f"Number of CTs before getting rid of erroneous ones: {len(testsplit)}")
testsplit=[t for t in testsplit if len(list(glob.glob(f"{prep_result_path}{t}*")))==2] #Get rid of erroneous ones
print(f"Number of CTs after getting rid of erroneous ones {len(testsplit)}")
